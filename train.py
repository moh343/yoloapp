#!/usr/bin/env python3
"""
YOLOv8 Training Script for yolo_prd
This script trains a YOLOv8 model on the exported dataset.
"""
...
def train_model(data_yaml_path, epochs=100, batch_size=16, img_size=640, model_size='n', base_dir=None,
    ...
    try:
        ...
        temp_yaml_path = os.path.join(os.path.dirname(data_yaml_path), "temp_data.yaml")
